// Package hash предоставляет функции для HMAC-SHA256 подписи данных.
//
// Sign вычисляет подпись, Verify проверяет её корректность.
// Используется для верификации целостности ответов сервера.
package hash
